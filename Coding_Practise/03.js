...
let seasonLargeImageElement = document.getElementById("seasonMediumImage");
...
function springBtn(){
  ...
  seasonLargeImageElement.src = springMediumImage;
}   
function summerBtn(){
    seasonSmallImageElement.src = summerSmallImage;
    seasonLargeImageElement.src = summerMediumImage;
}
function autumnBtn() {
  seasonSmallImageElement.src = autumnSmallImage;
  seasonLargeImageElement.src = autumnMediumImage;
}

function winterBtn() {
  seasonSmallImageElement.src = winterSmallImage;
  seasonLargeImageElement.src = winterMediumImage;
}